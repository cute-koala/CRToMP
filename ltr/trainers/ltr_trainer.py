...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        # 冻结
        freeze_backbone(self.actor.net.feature_extractor)
        ...
        for i, data in enumerate(loader, 1):
            ...
            # n_parameters = sum(p.numel() for p in self.actor.net.parameters() if p.requires_grad)
            ...
            if loader.training:
                ...
                loss.backward()
                torch.nn.utils.clip_grad_norm_(self.actor.net.parameters(), 0.1)
                self.optimizer.step()
    ...
    def train_epoch(self,Scaler=None):
