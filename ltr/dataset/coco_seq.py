...
class MSCOCOSeq(BaseVideoDataset):
    ...
    def has_segmentation_info(self,seq_id):
    ...
    def get_frames_in_class(self,seq_id=None,frame_ids=None):
        cat = self.get_class_name(seq_id)
        sequence = self.get_sequences_in_class(cat)
        frame_id = random.choice(sequence)
        return self.get_frames(frame_id,frame_ids)
